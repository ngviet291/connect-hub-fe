...
export const translations = {
  vi: {
    ...
    empty_feed_desc:
      "Hãy theo dõi thêm người dùng hoặc tạo connect đầu tiên của bạn.",
    ...
    blocked_status: "Đã chặn",
    success_block_user: "Đã chặn người dùng.",
    success_unblock_user: "Đã bỏ chặn người dùng.",
    ...
    uploading_video_progress: "Đang tải video lên... {{percent}}%",
    ...
    recall_confirm_desc:
      "Tin nhắn sẽ bị thu hồi với tất cả mọi người trong cuộc trò chuyện. Hành động này không thể hoàn tác.",
    ...
    blocked_users_title: "Danh sách người đã chặn",
    blocked_users_desc: "Quản lý những người bạn đã chặn.",
    blocked_users_empty: "Bạn chưa chặn người nào.",
    loading: "Đang tải...",
    ...
    messages_empty_hint:
      'Không có tin nhắn nào. Nhấn nút "Nhắn tin" để bắt đầu trò chuyện.',
    ...
    profile_completion_create_desc:
      "Chia sẻ suy nghĩ hoạt động nổi bật mới đây của bạn.",
    profile_completion_create_cta: "Tạo",
    profile_completion_follow_title: "Theo dõi 10 trang cá nhân",
    profile_completion_follow_desc:
      "Hãy lấp đầy bằng feed bằng những connect bạn quan tâm.",
    ...
    pending_conversation_hint:
      "Người này muốn nhắn tin cho bạn. Chấp nhận để bắt đầu trò chuyện.",
    pending_conversation_label: "Đang chờ bạn chấp nhận",
    pending_message_toast: "{{username}} đã gửi cho bạn 1 tin nhắn",
    accept_conversation_action: "Chấp nhận",
    accept_conversation_success: "Đã chấp nhận lời mời trò chuyện.",
    accept_conversation_error: "Không thể chấp nhận lời mời. Vui lòng thử lại.",
    send_message_error: "Gửi tin nhắn thất bại. Vui lòng thử lại.",
    recall_message_error: "Thu hồi tin nhắn thất bại. Vui lòng thử lại.",

    // Chat — group management
    create_group_title: "Tạo nhóm chat",
    group_name_label: "Tên nhóm",
    group_name_placeholder: "Nhập tên nhóm (không bắt buộc)",
    group_members_label: "Thành viên",
    group_members_min_hint: "Cần chọn tối thiểu 2 thành viên.",
    group_members_count: "{{count}} thành viên",
    create_group_action: "Tạo nhóm",
    group_create_error: "Không thể tạo nhóm. Vui lòng thử lại.",
    member_picker_empty: "Bạn chưa follow ai để thêm vào nhóm.",
    group_info_title: "Thông tin nhóm",
    group_update_success: "Đã cập nhật nhóm.",
    group_update_error: "Không thể cập nhật nhóm.",
    group_add_members_title: "Thêm thành viên",
    group_add_members_action: "Thêm thành viên",
    group_add_members_success: "Đã thêm thành viên vào nhóm.",
    group_add_members_error: "Không thể thêm thành viên.",
    group_remove_member_error: "Không thể xoá thành viên.",
    group_update_role_error: "Không thể đổi vai trò thành viên.",
    group_leave_error: "Không thể rời nhóm.",
    you_label: "bạn",
    role_admin: "Quản trị viên",
    role_member: "Thành viên",
    promote_action: "Đặt làm quản trị",
    demote_action: "Bỏ quyền quản trị",
    remove_action: "Xoá",
    leave_group_action: "Rời nhóm",
    leave_group_confirm_title: "Rời khỏi nhóm này?",
    leave_group_confirm_desc:
      "Bạn sẽ không nhận được tin nhắn mới từ nhóm này nữa.",
    remove_member_confirm_title: "Xoá thành viên này khỏi nhóm?",
  },
  en: {
    nav_home: "Home",
    feed_title: "For you",
    ...
    success_block_user: "User blocked.",
    success_unblock_user: "User unblocked.",
    ...
    uploading_video_progress: "Uploading video... {{percent}}%",
    ...
    recall_confirm_desc:
      "This message will be recalled for everyone in the conversation. This action cannot be undone.",
    react_action: "React",
    ...
    two_factor_desc:
      "Protect your account with an additional verification code.",
    ...
    theme_auto_hint:
      "The system will automatically detect your device's theme if you haven't manually selected one.",
    ...
    admin_users_desc_after:
      "Wire up the user list APIs (GetAllUser, ChangeStatus...) here.",
    ...
    // Chat — pending request
    pending_conversation_hint:
      "This person wants to message you. Accept to start chatting.",
    pending_conversation_label: "Waiting for your approval",
    pending_message_toast: "{{username}} sent you a message",
    accept_conversation_action: "Accept",
    accept_conversation_success: "Conversation request accepted.",
    accept_conversation_error:
      "Could not accept the request. Please try again.",
    send_message_error: "Failed to send message. Please try again.",
    recall_message_error: "Failed to recall message. Please try again.",

    // Chat — group management
    create_group_title: "Create group chat",
    group_name_label: "Group name",
    group_name_placeholder: "Enter a group name (optional)",
    group_members_label: "Members",
    group_members_min_hint: "Select at least 2 members.",
    group_members_count: "{{count}} members",
    create_group_action: "Create group",
    group_create_error: "Could not create the group. Please try again.",
    member_picker_empty: "You aren't following anyone to add yet.",
    group_info_title: "Group info",
    group_update_success: "Group updated.",
    group_update_error: "Could not update the group.",
    group_add_members_title: "Add members",
    group_add_members_action: "Add members",
    group_add_members_success: "Members added.",
    group_add_members_error: "Could not add members.",
    group_remove_member_error: "Could not remove member.",
    group_update_role_error: "Could not update member's role.",
    group_leave_error: "Could not leave the group.",
    you_label: "you",
    role_admin: "Admin",
    role_member: "Member",
    promote_action: "Make admin",
    demote_action: "Remove admin",
    remove_action: "Remove",
    leave_group_action: "Leave group",
    leave_group_confirm_title: "Leave this group?",
    leave_group_confirm_desc:
      "You'll stop receiving new messages from this group.",
    remove_member_confirm_title: "Remove this member from the group?",
  },
} as const;
