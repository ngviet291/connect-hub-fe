...
export const translations = {
  vi: {
    ...
    pending_conversation_hint: 'Người này muốn nhắn tin cho bạn. Chấp nhận để bắt đầu trò chuyện.',
    ...
    leave_group_confirm_desc: 'Bạn sẽ không nhận được tin nhắn mới từ nhóm này nữa.',
  ...
  en: {
    ...
    // Chat — pending request
    pending_conversation_hint: 'This person wants to message you. Accept to start chatting.',
    ...
    accept_conversation_error: 'Could not accept the request. Please try again.',
    ...
    leave_group_confirm_desc: "You'll stop receiving new messages from this group.",
